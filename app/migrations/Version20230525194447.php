 ...
 */
final class Version20230525194447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tasks_tag (note_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_3960F80726ED0855 (note_id), INDEX IDX_3960F807BAD26311 (tag_id), PRIMARY KEY(note_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE tasks_tag ADD CONSTRAINT FK_3960F80726ED0855 FOREIGN KEY (note_id) REFERENCES notes (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE tasks_tag ADD CONSTRAINT FK_3960F807BAD26311 FOREIGN KEY (tag_id) REFERENCES tag (id) ON DELETE CASCADE');
